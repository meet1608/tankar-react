...
const Blog_list = () => {
  ...
  <div className="blog-list-section scroll-margin pt-120 mb-120" id="blog-grid">
    <div className="container">
      <div className="blog-list-wrapper mb-50">
        <div
          className="blog-card2 style-2 border--top wow animate fadeInDown"
        ...
        <div
          className="blog-card2 style-2 last-item wow animate fadeInDown"
