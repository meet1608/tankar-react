...
import Software_img1 from "../assets/img/Services/Digital Marketing1.jpg";
import Software_img2 from "../assets/img/Services/Digital Marketing2.jpg";
const Service_details = () => {
  ...
  const faqData = [
    {
      ...
      content:
        "Digital marketing involves promoting brands using online platforms like SEO, social media, and email to reach potential customers.",
    },
    {
      title: "02. Why is digital marketing important for businesses?",
      content:
        "It enhances brand visibility, drives targeted traffic, and offers measurable results, ensuring higher engagement and growth.",
    },
    {
      title: "03. What strategies are used in digital marketing?",
      content:
        "Key strategies include SEO, PPC, content marketing, social media marketing, and email campaigns for optimal reach.",
    },
    {
      title: "04. How long does it take to see results?",
      content:
        "SEO may take 3-6 months for noticeable results, while PPC campaigns can deliver faster outcomes within weeks.",
    },
    {
      title: "05. What post-campaign support is offered?",
      content:
        "We provide performance analysis, ongoing optimization, and strategy adjustments to maximize long-term success.",
    },
  ];
              ...
              <div className="row g-lg-4 gy-5 align-items-center">
                ...
                >
                  <div className="service-details-top-content">
                    ...
                    <p>
                    Our digital marketing services are designed to boost your brand's online presence and drive engagement. We offer:
                    ...
                    <ul className="key-features">
                      ...
                      <li>
                        ...
                        Pay-Per-Click (PPC) Advertising                      </li>
                      <li>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={15}
  ...
  <p>
    {index === 0
      ? "We conduct in-depth market research to identify trends, target audiences, and competitor strategies for effective campaigns."
      : index === 1
      ? "We create customized marketing strategies that align with your business goals and maximize reach."
      : index === 2
      ? "Our team crafts engaging content, including blogs, visuals, and social media posts to attract and retain customers."
      : index === 3
      ? "We implement and manage campaigns across multiple platforms to boost visibility and drive conversions."
      : "We analyze campaign performance, refine strategies, and optimize results to ensure maximum ROI."}
  </p>
</div>
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                >
                  ...
                  <h2>
    Smart Strategies Drive That <span>Growth.</span>
</h2>
<p>
    Empower your brand with tailored digital marketing solutions designed to boost engagement,
    increase visibility, and drive conversions for lasting success.
</p>
...
<p>
    Creating data-driven strategies to reach the right audience and maximize engagement across digital platforms.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Crafting compelling content that builds brand authority, drives traffic, and boosts conversions.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Developing creative campaigns to enhance brand visibility and foster meaningful connections with your audience.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Improving website rankings with effective SEO strategies that increase organic traffic and visibility.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Tracking campaign results with detailed insights to refine strategies and ensure maximum ROI.
</p>
                    </div>
                  </li>
                </ul>
