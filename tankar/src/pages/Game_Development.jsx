...
import Software_img1 from "../assets/img/Services/Game Development1.jpg";
import Software_img2 from "../assets/img/Services/Game Development2.jpg";
const Service_details = () => {
  ...
  const faqData = [
    {
      title: "01. What is Game Development?",
      content:
        "Game development involves designing, coding, and creating interactive video games for platforms like mobile, PC, and consoles.",
    },
    {
      title: "02. What technologies are used in game development?",
      content:
        "Popular technologies include Unity, Unreal Engine, C#, and C++ to build immersive and high-performance games.",
    },
    {
      title: "03. What types of games can you develop?",
      content:
        "We develop mobile games, PC games, AR/VR experiences, and multiplayer games tailored to your ideas and goals.",
    },
    {
      title: "04. How long does it take to develop a game?",
      content:
        "Development timelines vary based on complexity, ranging from a few months for simple games to over a year for complex projects.",
    },
    {
      title: "05. What support is provided after game launch?",
      content:
        "We offer post-launch updates, bug fixes, performance enhancements, and new content integration for ongoing engagement.",
    },
  ];
              ...
              <div className="row g-lg-4 gy-5 align-items-center">
                ...
                >
                  <div className="service-details-top-content">
                    ...
                    <p>
                    Our game development services are designed to create immersive and engaging gaming experiences. We specialize in:
                    ...
                    <ul className="key-features">
                      ...
                      <li>
                        ...
                        Engaging Gameplay Mechanics                      </li>
                      <li>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={15}
  ...
  <p>
    {index === 0
      ? "We brainstorm creative game ideas, define core mechanics, and outline engaging storylines to build a strong foundation."
      : index === 1
      ? "We design captivating visuals, immersive environments, and intuitive UI/UX to enhance the player experience."
      : index === 2
      ? "Our developers build the game using advanced engines, ensuring smooth performance and engaging gameplay."
      : index === 3
      ? "We conduct thorough testing to identify bugs, improve stability, and deliver a flawless gaming experience."
      : "We ensure a successful launch and provide continuous updates, bug fixes, and support to maintain player engagement."}
  </p>
</div>
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                >
                  ...
                  <h2>
    Innovative Designs Drive That <span>Gameplay.</span>
</h2>
<p>
    Elevate your gaming experience with immersive designs, engaging mechanics, and seamless performance to captivate players worldwide.
</p>
...
<p>
    Creating captivating visuals, realistic environments, and engaging storylines to deliver unforgettable gaming experiences.
</p>
                    </div>
                  </li>
                  <li
                  ...
                  >
                    ...
                    <div className="content">
                    <h5>Dynamic Gameplay</h5>
<p>
    Implementing interactive mechanics, adaptive AI, and smooth controls to keep players engaged and entertained.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Building games that run seamlessly across PC, console, and mobile devices for a wider audience reach.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Ensuring fast load times, smooth frame rates, and minimal latency for an enhanced gaming experience.
</p>
...
<p>
    Providing updates, bug fixes, and new content integration to maintain player engagement and ensure long-term success.
</p>
                    </div>
                  </li>
                </ul>
