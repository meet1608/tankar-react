...
const Service_details = () => {
  ...
  const faqData = [
    {
      title: "01. What are ERP solutions?",
      content:
        "ERP solutions integrate core business processes like finance, HR, and supply chain into a unified system for improved efficiency.",
    },
    {
      title: "02. Why does my business need an ERP solution?",
      content:
        "ERP systems streamline operations, improve data management, and enhance decision-making for better business growth.",
    },
    {
      title: "03. What industries benefit from ERP solutions?",
      content:
        "Industries like manufacturing, retail, healthcare, and logistics benefit from ERP systems for improved resource management.",
    },
    {
      title: "04. How long does it take to implement an ERP system?",
      content:
        "ERP implementation timelines vary, typically taking 3-12 months depending on business size and system complexity.",
    },
    {
      title: "05. What support is provided after ERP implementation?",
      content:
        "We provide training, system updates, troubleshooting, and continuous support to ensure smooth operations and growth.",
    },
  ];
                  ...
                  <div className="service-details-top-content">
                    ...
                    <ul className="key-features">
                      ...
                      <li>
                        ...
                        Inventory & Supply Chain Management                      </li>
                      <li>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={15}
  ...
  <p>
    {index === 0
      ? "We assess your business operations to identify ERP requirements, ensuring a tailored solution for improved efficiency."
      : index === 1
      ? "We develop a strategic plan that aligns the ERP solution with your organization's workflows and objectives."
      : index === 2
      ? "We design a user-friendly interface that enhances navigation, improves adoption, and maximizes productivity."
      : index === 3
      ? "Our developers build and rigorously test the ERP system to ensure stability, security, and seamless performance."
      : "We deploy the ERP system smoothly and provide ongoing support to maintain optimal functionality and performance."}
  </p>
</div>
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                >
                  ...
                  <h2>
    Smart Solutions Drive That <span>Efficiency.</span>
</h2>
<p>
    Empower your business with integrated ERP solutions that streamline processes, enhance productivity, and drive growth.
</p>
...
<p>
    Streamlining business operations with automated workflows to boost efficiency and reduce manual effort.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Centralizing data to provide real-time insights, improved reporting, and better decision-making.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Connecting multiple departments and processes into a unified ERP platform for seamless collaboration.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Designing flexible ERP systems that grow with your business and adapt to evolving needs.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Providing continuous updates, troubleshooting, and performance enhancements to keep your ERP system running smoothly.
</p>
                    </div>
                  </li>
                </ul>
