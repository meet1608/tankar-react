...
const Product_details = () => {
        ...
        <div className="col-lg-12">
          <div className="banner-wrapper">
            <div className="banner-content">
              ...
              <h1>
                Decoding The Cloud And Deep Dive Told That Creative Designs For
                Work.
              </h1>
            </div>
      ...
      <div className="row gy-5">
        ...
        <div className="col-lg-6">
          <div className="product-details-content">
            ...
            <p>
              Nourish and indulge with our luxurious Woman Body Cream. Hydrate,
              soften, and enhance your skin's natural radiance effortlessly.
            </p>
            ...
            <div className="payment-method">
              ...
              <ul className="payment-card-list">
                <li>
                  <img src="assets/img/innerpage/payment-img1.svg" alt="" />
                </li>
                <li>
                  <img src="assets/img/innerpage/payment-img2.svg" alt="" />
                </li>
                <li>
                  <img src="assets/img/innerpage/payment-img3.svg" alt="" />
                </li>
                <li>
                  <img src="assets/img/innerpage/payment-img4.svg" alt="" />
                </li>
                <li>
                  <img src="assets/img/innerpage/payment-img5.svg" alt="" />
                </li>
                <li>
                  <img src="assets/img/innerpage/payment-img6.svg" alt="" />
                </li>
                <li>
                  <img src="assets/img/innerpage/payment-img7.svg" alt="" />
                </li>
              </ul>
            </div>
  ...
  {/* Start Product Details description section */}
            ...
            <div className="tab-content" id="nav-tabContent">
              ...
              >
                <div className="description-content">
                  <p>
                    Indulge your skin in luxurious hydration with our Woman Body
                    Cream, a nourishing blend designed to pamper and rejuvenate.
                    Immerse yourself in the velvety texture as it glides
                    effortlessly, leaving your skin feeling soft, supple, and
                    beautifully moisturized.Enriched with premium ingredients,
                    this body cream is formulated to provide intense hydration
                    while promoting a radiant, youthful glow.
                  </p>
                  <p>
                    The carefully selected blend of vitamins and antioxidants
                    works harmoniously to replenish and revitalize your skin,
                    making it an essential part of your daily skincare routine.
                    Whether you're looking to soothe dryness, enhance skin
                    elasticity, or simply treat yourself to a moment of
                    self-care, our Woman Body Cream is the perfect solution.
                    Embrace the luxury of silky-smooth skin and experience the
                    delight of a product crafted with care to enhance your
                    natural beauty. Elevate your skincare ritual with our Woman
                    Body Cream and embrace the indulgence of healthy, radiant
                    skin.
                  </p>
                </div>
              </div>
                                ...
                                <div className="single-comment-area">
                                  ...
                                  <div className="comment-content">
                                    ...
                                    <p>
                                      ...
                                      choosing a car dealership for purchasing a
                                      vehicle"
                                    </p>
                                    <div className="replay-btn">
                                      <svg
