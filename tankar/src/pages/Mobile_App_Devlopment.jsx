        ...
        <div className="col-lg-12">
          <div className="banner-wrapper">
            <div className="banner-content">
              ...
              <h1>Custom mobile app development for seamless, scalable, and innovative user experiences.</h1>
            </div>
              ...
              <div className="accordion" id="accordionTravel">
                <div className="accordion-item">
                  <h2 className="accordion-header" id="faqheadingOne">
                    ...
                    >
                      01. What platforms do you develop mobile apps for?
                    </button>
                  </h2>
                  <div
                    id="faqcollapseOne"
                  ...
                  >
                    ...
                    We develop apps for iOS, Android, and cross-platform solutions using Flutter, React Native, and other technologies.
                ...
                <div className="accordion-item">
                  <h2 className="accordion-header" id="faqheadingTwo">
                    ...
                    >
02️. How long does it take to develop a mobile app?
</button>
                  </h2>
                  <div
                    id="faqcollapseTwo"
                  ...
                  >
                    <div className="accordion-body">
                    The development timeline depends on the complexity and features. A basic app takes around 2-3 months, while complex apps require 4-6 months or more.
                ...
                <div className="accordion-item">
                  <h2 className="accordion-header" id="faqheadingThree">
                    ...
                    >
                      03. Do you provide post-launch support?
                    </button>
                  </h2>
                  <div
                    id="faqcollapseThree"
                  ...
                  >
                    <div className="accordion-body">
                    Yes! We offer maintenance, bug fixes, updates, and feature enhancements post-launch.
                ...
                <div className="accordion-item">
                  <h2 className="accordion-header" id="faqheadingFour">
                    ...
                    >
                      04. Can you integrate third-party APIs into my app?
                    </button>
                  </h2>
                  <div
                    id="faqcollapseFour"
                  ...
                  >
                    <div className="accordion-body">
                    Absolutely! We can integrate payment gateways, social media logins, geolocation services, and more.
                ...
                <div className="accordion-item">
                  <h2 className="accordion-header" id="faqheadingFive">
                    ...
                    >
                      05. How do you ensure app security?
                    </button>
                  </h2>
                  <div
                    id="faqcollapseFive"
                  ...
                  >
                    <div className="accordion-body">
                    We use encryption, secure authentication, and regular security audits to protect user data and prevent breaches.
                ...
                >
                  <div className="single-process">
                    ...
                    <div className="content">
                      ...
                      <p>
                      We discuss your app idea, target audience, and business goals to define a clear roadmap.
                ...
                >
                  <div className="single-process">
                    ...
                    <div className="content">
                      <h4>UI/UX Design</h4>
                      <p>
                      Our designers craft an intuitive, visually appealing, and engaging user experience.
                ...
                >
                  <div className="single-process">
                    ...
                    <div className="content">
                      ...
                      <p>
                      Our developers use the latest technologies to build a high-performing mobile application.
                ...
                >
                  <div className="single-process">
                    ...
                    <div className="content">
                      ...
                      <p>
                      We conduct rigorous testing to ensure smooth performance, security, and bug-free functionality.
                ...
                <div className="swiper-slide">
                  <div className="single-process">
                    ...
                    <div className="content">
                      ...
                      <p>Your app is launched on app stores, and we provide ongoing maintenance and updates.
      ...
      <div className="row">
        <div className="col-lg-6">
          ...
          >
            ...
            <h2>
            Transform Your Ideas into <span> Powerful Mobile Experiences</span>
            </h2>
            <p>
            We create innovative, scalable, and user-friendly mobile applications tailored to your business needs, ensuring seamless functionality and top-tier performance.
        ...
        <div className="col-lg-6">
          <ul className="service-feature-list">
            ...
            >
              ...
              <div className="content">
                <h5>Native & Cross-Platform Development</h5>
                <p>Build apps for iOS, Android, or both using the latest technologies. </p>
              </div>
            </li>
            <li
              className="single-feature wow animate fadeInDown"
            ...
            >
              ...
              <div className="content">
                <h5>Seamless UI/UX Integration</h5>
                <p>Ensure a smooth, engaging user experience with intuitive design. </p>
              </div>
            </li>
            <li
              className="single-feature wow animate fadeInDown"
            ...
            >
              ...
              <div className="content">
                <h5> Secure & Scalable Architecture</h5>
                <p>Develop apps with robust security protocols and future scalability.</p>
              </div>
            </li>
            <li
              className="single-feature wow animate fadeInDown"
            ...
            >
              ...
              <div className="content">
                <h5>AI & IoT Integration</h5>
                <p>Leverage cutting-edge AI and IoT features for enhanced functionality.
                </p>
              </div>
            </li>
            <li
            ...
            >
              ...
              <div className="content">
                <h5>Continuous Maintenance & Updates</h5>
                <p>Keep your app updated, secure, and optimized for performance.
