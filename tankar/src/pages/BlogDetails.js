...
const BlogDetails = () => {
  const { id } = useParams();
  const blog = blogsList.find((b) => b.id.toString() === id);
              ...
              <div className="col-lg-12">
                <div className="banner-wrapper">
                  <div className="banner-content">
                    ...
                    <h1>
                      Tankar Solutions Private Limited drives innovation with IT
                      solutions for business digital growth.
                    </h1>
                  </div>
              ...
              <div className="col-lg-8">
                <div className="blog-details-content mb-0">
                  <p className="first-para">
                    ...
                    innovative and reliable IT solutions to stay ahead. Tankar
                    Solutions Private Limited is at the forefront of this
                    transformation, providing world-class IT services that
                    streamline operations, enhance security, and drive
                    efficiency. From cloud computing and data analytics to
                    AI-driven automation and custom software development, Tankar
                    Solutions Private Limited helps businesses leverage the
                    latest technologies to improve productivity and gain a
                    competitive edge. With a client-centric approach, the
                    company tailors IT strategies to meet the unique needs of
                    enterprises across various industries.
                  </p>
                  <p className="second-para">
                    Beyond technology implementation, Tankar Solutions Private
                    Limited excels in IT consulting, helping businesses align
                    their digital transformation goals with market demands.
                    Their expertise in cybersecurity ensures that organizations
                    are protected against evolving cyber threats, while their
                    mobile and web development services create high-performing,
                    user-friendly platforms. By integrating advanced IT
                    solutions, Tankar Solutions Private Limited empowers
                    businesses to scale, innovate, and achieve long-term success
                    in the digital era.
                  </p>
                  <blockquote className="text-center mb-50">
                    <p className="blockquote-text">
                      "Their software development solutions were tailored to our
                      needs, making our operations more streamlined and
                      effective."
                    </p>
                  ...
                  <h3>Unveiling Digital Transformation</h3>
                  <p>
                    Explore how Tankar Solutions Private Limited is
                    revolutionizing businesses with its advanced IT services.
                    Our expertise in mobile app development, web solutions, and
                    IT consulting empowers enterprises to optimize operations
                    and drive growth. Stay ahead in the digital landscape with
                    our tailored, cutting-edge solutions.
                  </p>
                  ...
                  <h3>Exploring Our IT Innovations</h3>
                  <p>
                    Discover the impact of Tankar Solutions Private Limited’s
                    services in transforming businesses globally. From UI/UX
                    enhancements to seamless software development, our solutions
                    are designed to boost efficiency, security, and scalability.
                    Experience the power of technology-driven success with us.
                  </p>
                  <ul>
                    <li>
                      <svg
                  ...
                  <div className="single-widget mb-30">
                    ...
                    <ul className="category-list">
                      ...
                      <li>
                        <a href="blog-sidebar.html">
                          <span
                            onClick={() => navigate("/digital-marketing-page")}
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width={13}
