...
import Software_img1 from "../assets/img/Services/Custom Software Development1.jpg";
import Software_img2 from "../assets/img/Services/Custom Software Development2.jpg";
const Service_details = () => {
  ...
  function moveSlide(direction) {
    ...
    // Ensure all slides are visible but only the active one is opaque
    slides.forEach((slide, index) => {
      ...
      slide.style.top = `${currentIndex * 100}px`; // Ensures position stays in place
    });
  
    // Adjust container height to match active slide
    const activeSlideHeight = slides[currentIndex].offsetHeight;
    sliderWrapper.style.height = `${activeSlideHeight}px`;
  }
  ...
  const faqData = [
    {
      title: "01. What is Custom Software Development?",
      content:
        "Custom software development involves creating tailored solutions to meet specific business needs, enhancing efficiency and scalability.",
    },
    {
      title: "02. Why choose custom software development?",
      content:
        "It provides personalized solutions that align with your business goals, improving performance, automation, and flexibility.",
    },
    {
      title: "03. What types of custom software do you offer?",
      content:
        "We develop web, mobile, and enterprise-grade software, including CRM systems, APIs, and scalable solutions for diverse industries.",
    },
    {
      title: "04. How secure are custom software solutions?",
      content:
        "We use advanced security protocols, encryption, and regular updates to ensure your software is secure and future-ready.",
    },
    {
      title: "05. What support do you provide after deployment?",
      content:
        "We offer ongoing maintenance, updates, and technical support to ensure your software evolves with your business needs.",
    },
  ];
              ...
              <div className="row g-lg-4 gy-5 align-items-center">
                ...
                >
                  <div className="service-details-top-content">
                    ...
                    <p>
                    Our custom software development services are designed to deliver personalized solutions that align perfectly with your business objectives. We specialize in:
                    </p>
                ...
                <div
                  className="service-details-faq-area"
                  style={{
                      ...
                      {faqData.map((item, index) => (
                        ...
                        >
                          <h2
                            ...
                            style={{
                              backgroundColor:
                                activeIndex === index ? "#558fdc" : "#fff",
                              color: activeIndex === index ? "#fff" : "#000",
                              padding: "18px", // Balanced padding for better size
                              fontSize: "20px", // Medium-sized font for readability
                              cursor: "pointer",
                          ...
                          <div
                            ...
                            style={{
                              maxHeight: activeIndex === index ? "180px" : "0", // Balanced height
                              ...
                              padding:
                                activeIndex === index ? "12px" : "0 12px", // Balanced padding
                              fontSize: "16px", // Slightly larger content font
  ...
  <div className="process-slider-area" style={{ position: 'relative', overflow: 'hidden' }}>
    <div className="row">
      <div className="col-lg-12">
        <div className="swiper home2-process-slider" style={{ transition: 'transform 0.5s ease-in-out' }}>
          <div className="swiper-wrapper" id="sliderWrapper">
            {[...Array(5)].map((_, index) => (
              <div
                key={index}
              ...
              >
                <div className="single-process" style={{ padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '10px', marginBottom: '10px' }}>
  ...
  <p>
    {index === 0
      ? "We gather your business requirements to design custom software that aligns with your goals and optimizes performance."
      : index === 1
      ? "We create a strategic roadmap, outlining timelines, milestones, and resources for successful project execution."
      : index === 2
      ? "We design user-centric, intuitive interfaces that enhance usability and improve customer engagement."
      : index === 3
      ? "Our development team builds robust software and conducts comprehensive testing to ensure quality and performance."
      : "We deploy your software efficiently and provide continuous maintenance to ensure long-term success."}
  </p>
</div>
        ...
        <div className="slider-btn-area" style={{ display: 'flex', justifyContent: 'center', gap: '15px', marginTop: '15px' }}>
          <div
            className="slider-btn home2-process-prev"
            onClick={() => moveSlide(-1)}
            style={{ cursor: 'pointer', padding: '10px', backgroundColor: '#ddd', borderRadius: '50%' }}
          >
          ...
          <div
            className="slider-btn home2-process-next"
            onClick={() => moveSlide(1)}
            style={{ cursor: 'pointer', padding: '10px', backgroundColor: '#ddd', borderRadius: '50%' }}
          >
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                >
                  ...
                  <h2>
    Innovative Solutions Drive That <span>Success.</span>
</h2>
<p>
    Unlock your business potential with custom software solutions tailored to meet your unique needs, ensuring efficiency and growth.
</p>
...
<p>
    Building tailored software solutions from the ground up. Our custom development ensures precision, scalability, and seamless integration for optimal performance.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Delivering innovative software designs that enhance user experience, improve efficiency, and drive business growth.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Ensuring flexible and adaptive development processes for faster delivery, improved collaboration, and continuous enhancement.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    Designing software frameworks that grow with your business, ensuring long-term stability and performance.
</p>
                    </div>
                  </li>
                  <li
...
<p>
    From ideation to deployment and maintenance, we provide comprehensive support to ensure your custom software achieves maximum impact.
</p>
                    </div>
                  </li>
                </ul>
              ...
              <div className="col-lg-5">
                <div className="contact-content">
                  ...
                  >
                    ...
                    <p>
                      Ready to unlock opportunities, achieve goals, and embrace
