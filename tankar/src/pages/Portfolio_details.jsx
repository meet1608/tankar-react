  ...
  >
    <div className="container">
      <div className="portfolio-details-thumb mb-80">
        <img src="assets/img/innerpage/portfolio-details-thumb.jpg" alt="" />
      </div>
      <div className="row g-lg-4 gy-5 mb-80 ">
        <div className="col-lg-8">
          <div className="portfolio-details-content">
            ...
            <p>
              Step into the heart of my creative journey through this portfolio
              showcase. Each project tells a unique story, a testament to the
              passion and dedication poured into every pixel. Explore the fusion
              of design and innovation, where every detail is a brushstroke in
              the canvas of my professional odyssey.{" "}
            </p>
            ...
            <p>
              Welcome to our portfolio details page, where each project tells a
              unique story of innovation and creativity. Here, we invite you to
              explore our diverse collection of work, each piece meticulously
              crafted to exceed expectations and inspire awe.
            </p>
            ...
            <p>
              Discover the tangible outcomes of our creative endeavors in the
              project results section. Witness how our team's dedication,
              expertise, and passion have translated conceptual visions into
              impactful realities.Dive into the metrics, testimonials, and
              visual representations that showcase the concrete achievements and
              positive impact generated by our work.
            </p>
          </div>
        </div>
        <div className="col-lg-4">
          ...
          <div className="portfolio-details-banner">
            <img src="assets/img/innerpage/portfolio-banner-img.jpg" alt="" />
            <div className="portfolio-details-banner-content">
              <h2>
                Ready to <span>work with us?</span>
              </h2>
              <a href="contact.html" className="primary-btn4 black-hover">
                Get a quote
              </a>
            </div>
          </div>
