              ...
              <div className="col-lg-12">
                <div className="banner-wrapper">
                  <div className="banner-content">
                    ...
                    <h1>
                      Custom, Mobile & Web Apps | Enterprise Solutions |
                      Consulting & Support
                    </h1>
                  </div>
              ...
              <div className="row g-lg-4 gy-5 align-items-center">
                ...
                >
                  <div className="service-details-top-content">
                    ...
                    <p>
                      At Tankar Solutions Private Limited, we turn ideas into
                      reality through innovative software solutions. With a
                      strong foundation in cutting-edge technology, we help
                      businesses achieve digital transformation with tailored
                      software services. From startups to enterprises, our
                      expert team delivers scalable, secure, and high-performing
                ...
                >
                  <div className="service-details-img">
                    <img
                      ...
                      alt=""
                    />
                    <img className="black" src={Software_img1} alt="" />
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="faq-content">
                    <div className="accordion" id="accordionTravel">
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            We build enterprise software, cloud-based
                            applications, AI-powered solutions, and more.
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            Yes! We handle everything from planning and
                      ...
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            We follow Agile methodologies, rigorous testing, and
                            security audits.
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item">
                        <h2 className="accordion-header" id="faqheadingFour">
                          ...
                          >
                            04. Can you integrate new software with our existing
                            system?
                          </button>
                        </h2>
                        <div
                        ...
                        >
                          <div className="accordion-body">
                            Yes! We ensure seamless integration with your
                      ...
                      <div className="accordion-item">
                        <h2 className="accordion-header" id="faqheadingFive">
                          ...
                          >
                            05. What technologies do you use for software
                            development?
                          </button>
                        </h2>
                        <div
                        ...
                        >
                          <div className="accordion-body">
                            We use Python, Java, .NET, PHP, Node.js, and more
                      ...
                      >
                        <div className="single-process">
                          ...
                          <div className="content">
                            ...
                            <p>
                              Understanding business needs, defining scope, and
                      ...
                      >
                        <div className="single-process">
                          ...
                          <div className="content">
                            ...
                            <p>
                              Creating software architecture, UI mockups, and
                              database structures.
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        <div className="single-process">
                          ...
                          <div className="content">
                            ...
                            <p>
                              Building the software using Agile methodology for
                              efficiency.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="swiper-slide">
                        <div className="single-process">
                          ...
                          <div className="content">
                            ...
                            <p>
                              Launching the software and providing ongoing
                              support and updates.
                            </p>
                          </div>
                        </div>
              ...
              <div className="col-lg-6">
                ...
                >
                  ...
                  <h2>
                    ...
                    <span> Solutions for Business Success</span>
                  </h2>
                  <p>
                    We develop custom software solutions that streamline
                ...
                <ul className="service-feature-list">
                  ...
                  >
                    ...
                    <div className="content">
                      ...
                      <p>
                        Develop applications tailored to business-specific
                        needs.
                      </p>
                    </div>
                  </li>
                  ...
                  >
                    ...
                    <div className="content">
                      ...
                      <p>
                        Utilize agile methodologies for flexible and efficient
                        project execution.
                      </p>
                    </div>
                  </li>
                  ...
                  >
                    ...
                    <div className="content">
                      ...
                      <p>
                        Build robust APIs and databases for seamless
                        connectivity.
                      </p>
                    </div>
                  </li>
                  ...
                  >
                    ...
                    <div className="content">
                      ...
                      <p>Offer ongoing maintenance and feature enhancements.</p>
                    </div>
                  </li>
                </ul>
              </div>
