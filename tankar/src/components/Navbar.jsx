...
const Navbar = () => {
        ...
        <div className="col-lg-8">
          <div className="sidebar-menu-wrap">
            <ul className="main-menu">
              ...
              <li>
              <a onClick={() => navigate('/case-study1')}> Case Studies</a>
              <span className="dropdown-icon2">
                  <i className="bi bi-plus" />
                </span>
                <ul className="submenu-list">
              ...
              <li>
              <a onClick={() => navigate('/blog-grid')}> Blog</a>
              <span className="dropdown-icon2">
                  <i className="bi bi-plus" />
                </span>
                <ul className="submenu-list">
                  <li>
                  <a onClick={() => navigate('/blog-grid')}>
                      Blog Grid
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={10}
                  ...
                  <li>
                  <a onClick={() => navigate('/blog-grid-sidebar')}>
                      Blog Grid Sidebar
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={10}
                  ...
                  <li>
                  <a onClick={() => navigate('/blog-details')}>
                  ...
                  <li>
                  <a onClick={() => navigate('/blog-details2')}>
  ...
  <header className="header-area style-1 position-fixed" style={{
    ...
    <div className="container d-flex flex-nowrap align-items-center justify-content-between">
      ...
      <div className="main-menu d-lg-flex d-none">
        <ul className="menu-list">
            ...
            <ul className="sub-menu">
              <li className="active">
                ...
                <ul className="sub-menu">
                  ...
                  <li>
                    <a onClick={() => navigate('/creative-agency')}>Creative Agency</a>
                  </li>
                  <li>
                    <a onClick={() => navigate('/it-solutions')}>It Solution</a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul className="sub-menu">
                  <li>
                    <a onClick={() => navigate('/index-dark')}>Startup Agency</a>
                  </li>
                  <li>
                    <a onClick={() => navigate('/digital-marketing-dark')}>
                      Digital Marketing Agency
                  ...
                  <li>
                    <a onClick={() => navigate('/saas-dark')}>Saas Product</a>
                  </li>
                  <li>
                    <a onClick={() => navigate('/creative-agency-dark')}>Creative Agency</a>
                  </li>
                  <li>
                    <a onClick={() => navigate('/it-solutions-dark')}>It Solution</a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <li className="menu-item-has-children">
            <a onClick={() => navigate('/case-study1')} className="drop-down">
              Case Study
            </a>
            <i className="bi bi-plus dropdown-icon" />
            <ul className="sub-menu">
              <li>
                <a onClick={() => navigate('/case-study1')}>Case Study Style 01</a>
              </li>
              <li>
                <a onClick={() => navigate('/case-study2')}>Case Study Style 02</a>
              </li>
              <li>
                <a onClick={() => navigate('/case-study-details')}>Case Study Details</a>
              </li>
            </ul>
          </li>
          <li className="menu-item-has-children">
            <a onClick={() => navigate('/blog-grid')} className="drop-down">
              Blog
            </a>
            <i className="bi bi-plus dropdown-icon" />
            <ul className="sub-menu">
              <li>
                <a onClick={() => navigate('/blog-grid')}>Blog Grid</a>
              </li>
              <li>
                <a onClick={() => navigate('/blog-grid-sidebar')}>Blog Grid Sidebar</a>
              </li>
              <li>
                <a onClick={() => navigate('/blog-list')}>Blog List</a>
              </li>
              <li>
                <a onClick={() => navigate('/blog-standard')}>Blog Standard</a>
              </li>
              <li>
                <a onClick={() => navigate('/blog-details')}>Blog Details Style 01</a>
              </li>
              <li>
                <a onClick={() => navigate('/blog-details2')}>Blog Details Style 02</a>
              </li>
            </ul>
          </li>
          <li className="menu-item-has-children">
            ...
            <ul className="sub-menu">
              ...
              <li>
                ...
                <ul className="sub-menu">
                  <li>
                    <a onClick={() => navigate('/portfolio-grid')}>Portfolio Grid</a>
                  </li>
                  <li>
                    <a onClick={() => navigate('/portfolio-masonary')}>Portfolio Masonary</a>
                  </li>
                  <li>
                    <a onClick={() => navigate('/portfolio-info-flow')}>Portfolio Info Flow</a>
                  </li>
                  <li>
                    <a onClick={() => navigate('/portfolio-list')}>Portfolio List</a>
                  </li>
                  <li>
                    <a onClick={() => navigate('/portfolio-details')}>Portfolio Details</a>
                  </li>
                </ul>
              </li>
              <li>
              ...
              <li>
                ...
                <ul className="sub-menu">
                  ...
                  <li>
                    <a onClick={() => navigate('/product-details')}>Product Details</a>
                  </li>
                  <li>
              ...
              <li>
                <a onClick={() => navigate('/pricing-plan')}>Pricing Plan</a>
              </li>
              <li>
